...
urlpatterns = [
    ...
    path('dynamics/all', views.DynamicList.as_view()),
    path('dynamics/add', views.DynamicAdd.as_view()),
    path('dynamics/delete', views.DynamicDelete.as_view()),
    path('dynamics/search', views.DynamicSearch.as_view()),
    path('dynamics/<str:name>', views.DynamicUser.as_view()),
